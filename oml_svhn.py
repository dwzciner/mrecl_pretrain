...
def main():
    ...
    args['traj_classes'] = list(range(int(10 / 2), 10))
    ...
    iterator_test = torch.utils.data.DataLoader(dataset_test, batch_size=64,
                                                shuffle=True, num_workers=1)

    iterator_train = torch.utils.data.DataLoader(dataset, batch_size=64,
                                                 shuffle=True, num_workers=1)
