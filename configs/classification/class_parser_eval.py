...
class Parser(configargparse.ArgParser):
    def __init__(self):
        ...
        self.add('--dataset', help='Name of experiment')
        self.add("--no-reset", action="store_true")
        self.add('--seed', nargs='+', help='Seed', default=[90], type=int)
        self.add('--name', help='Name of experiment', default="evaluate_")
        ...
        self.add('--d', type=int, help='feature dimension', default=64)
        self.add('--eps', type=int, help='distortion', default=1)
